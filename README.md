...
I'm Felipe, a full-stack software engineer based in Galway, Ireland. Currently completing my Higher Diploma in Computer Science @ [CCT Dublin](https://www.cctcollege.com), mentoring on the Programming module, and building open-source AI dev tooling on the side.
...
- [sourcemap-indexer](https://github.com/lipex360x/sourcemap-indexer): code-indexing tool for LLM-assisted dev workflows. Python, 629 tests at 100% coverage.
- [dev-quality](https://github.com/lipex360x/dev-quality): linters, hooks and bootstrap scripts that hold AI-generated code to the same bar as anything else. Currently Python, pipeline ready for other languages.
- [docx_builder](https://github.com/lipex360x/docx_builder): generates `.docx` files (including my own CV) from a YAML description, so documents go through git like code.
- [github-toolkit](https://github.com/lipex360x/github-toolkit): Bash dispatcher that scaffolds repos, labels, project boards, milestones and releases from JSON fixtures in a single command.
- [cct-hdip-study](https://github.com/lipex360x/cct-hdip-study): multilingual study materials for CCT classes, deployed at [hdip-study-notes.vercel.app](https://hdip-study-notes.vercel.app).
- [web-view](https://github.com/lipex360x/web-view): project-agnostic Chrome/CDP toolkit on Playwright. Wait on state, never on time.
...
- Jest, pytest, JUnit
- pre-commit, [`dev-quality`](https://github.com/lipex360x/dev-quality) (own toolkit), 95%+ coverage targets
